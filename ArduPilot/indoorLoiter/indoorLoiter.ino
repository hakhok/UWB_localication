...
int32_t anchors_x[NUM_ANCHORS] = {27,     4725, 27,     4725};    // anchor x-coorindates in mm (horizontal)
int32_t anchors_y[NUM_ANCHORS] = {44,     494,     2787, 2795};    // anchor y-coordinates in mm (vertical)
int32_t heights[NUM_ANCHORS] =   {1132, 1165, 2415, 1184};    // anchor z-coordinates in mm (1.2m above vehicle's starting altitude)
