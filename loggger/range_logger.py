...
if __name__ == "__main__":
    ...
    remote_id = 0x6834           # the network ID of the remote device
    remote = True               # whether to use the given remote device for ranging
    if not remote:
        remote_id = None

    destination_id = 0x684E      # network ID of the ranging destination
